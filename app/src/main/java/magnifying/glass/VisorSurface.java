...
import magnifying.glass.filters.BlueYellowColorFilter;
import magnifying.glass.filters.ColorFilter;
import magnifying.glass.filters.NoColorFilter;
import magnifying.glass.filters.WhiteBlackColorFilter;
import magnifying.glass.filters.YellowBlueColorFilter;
import magnifying.glass.threads.BitmapCreateThread;
...
public class VisorSurface extends SurfaceView implements SurfaceHolder.Callback, BitmapRenderer {
    ...
    public void enableCamera() {
        ...
        // @see https://play.google.com/apps/publish/?#AndroidMetricsErrorsPlace:p=magnifying.glass&appVersion=PRODUCTION&lastReportedRange=LAST_60_DAYS&clusterName=apps/magnifying.glass/clusters/61aebe9b
